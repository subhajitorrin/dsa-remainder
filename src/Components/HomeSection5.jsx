  ...
  return (
    <div className=" h-screen pl-40 pr-40  homesection1 flex">
      <div className="h-full w-[50%]">
        <div className="mb-[50px]">
          ...
          <p className="font-semibold">
            Find answer to common questions about our service and the benifits
            of regular DSA practice
          </p>
        </div>
        <div className="flex flex-col gap-3 mb-5">
          ...
          <p>
            ...
            at a specific time users will receive a remainder email with a link
            to the questino. On the site. there is a <br />
            dashboard that shows the questions send with the date. Users can
            also update their profile name and <br />
        ...
        <div className="flex flex-col gap-3 mb-5">
          ...
          <p>
            ...
            performance in coding interviews and competitive programming
            contests.
          </p>
          <hr />
        </div>
      ...
      <div className="h-full w-[50%] flex items-center justify-center">
        <div className="img3 h-[700px] w-[700px]"></div>
      </div>
    </div>
  );
}
